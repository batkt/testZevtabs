  ...
  <div className="container mx-auto px-4 md:px-6 grid md:grid-cols-3 gap-10 w-full">
     <div className="mb-10 md:mb-0"> 
          ...
          <p className="text-gray-400 mb-6 text-left">
            Дэвшилтэд технологи ашиглан таны бизнесийн ашгийг нэмэгдүүлж, хяналтыг сайжруулна
          </p>
          <div>
            <div className="text-[#475569] text-[16px] font-semibold mb-1">Холбоо барих</div>
            <div className="text-[#475569] text-[13px] mb-1">
              ХУД, 15-р хороо, Ихнаяд таур 1211 тоот
            </div>
            <div className="text-[#475569] text-[13px] mb-1">(+976) 77072707</div>
          ...
          <ul className="space-y-3">
            {[
              ...
              <li key={index} className="flex items-center space-x-2 group relative">
                ...
                {item.badge && (
                  <span className={`text-xs px-2 py-0.5 rounded text-white ${item.badgeColor}`}>
                    {item.badge}
                  </span>
                )}
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-2 group">
                ...
                <span className="bg-green-500 text-xs px-2 py-0.5 rounded text-white">New</span>
              </li>
              <li>
                <a 
                  href="#" 
